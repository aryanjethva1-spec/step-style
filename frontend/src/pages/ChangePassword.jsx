...
import { Container, Card, Form, Button, Alert, Spinner, Row, Col, ProgressBar, InputGroup } from 'react-bootstrap';
import { FaLock, FaKey, FaShieldAlt, FaArrowLeft, FaEye, FaEyeSlash, FaInfoCircle, FaCheck, FaTimes, FaShieldVirus } from 'react-icons/fa';
                    ...
                    <Col lg={6} md={8}>
                        ...
                        <Card className="border-0 shadow-lg rounded-4 overflow-hidden mb-5">
                            <Card.Body className="p-4 p-md-5">
                                {error && <Alert variant="danger" className="rounded-4 border-0 shadow-sm mb-4 fade-in d-flex align-items-center gap-2">
                                    <FaTimes /> {error}
                                </Alert>}
                                {success && <Alert variant="success" className="rounded-4 border-0 shadow-sm mb-4 fade-in d-flex align-items-center gap-2">
                                    <FaCheck /> {success}
                                </Alert>}
                                ...
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <Form.Group className="mb-5">
                                        ...
                                        {confirmPassword && newPassword !== confirmPassword && (
                                            <small className="text-danger fw-bold ms-3"><FaTimes className="me-1" /> Passwords do not match</small>
                                        )}
                                        {confirmPassword && newPassword === confirmPassword && confirmPassword.length >= 8 && (
                                            <small className="text-success fw-bold ms-3"><FaCheck className="me-1" /> Passwords match</small>
                                        )}
                                    </Form.Group>
                                    ...
                                    <Row className="g-3">
                                        ...
                                        <Col xs={12}>
                                            <Button 
                                                ...
                                                className="w-100 rounded-pill py-3 fw-black text-uppercase letter-spacing-1 border-2"
